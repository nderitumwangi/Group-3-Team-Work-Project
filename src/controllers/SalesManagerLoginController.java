...
public class SalesManagerLoginController implements Initializable {
    ...
    @FXML
    private Button btnSellerSignin;
    ...
    public void handleButtonAction(MouseEvent event) throws IOException {
        ...
        if (event.getSource() == btnSignin) {
            ...
            if (logIn().equals("Success")) {
                try {
                    ...
                    stage.close();
                    Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/fxml/SalesManagerDashboard.fxml")));
        ...
        if(event.getSource()==btnSellerSignin){
    ...
    public SalesManagerLoginController() {
        con = Connect.conDB();
